...
public abstract class BaseCat implements Cat{
    ...
    private static final int SHORT_HAIR_CAT_INITIAL_WEIGHT = 7;
    private static final int LONG_HAIR_CAT_INITIAL_WEIGHT = 9;
    ...
    public void eating() {
        if ("ShorthairCat".equals(getClass().getSimpleName())) {
            kilograms = SHORT_HAIR_CAT_INITIAL_WEIGHT + 1;
        } else if ("LonghairCat".equals(getClass().getSimpleName())) {
