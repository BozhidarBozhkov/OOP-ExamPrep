...
public class ControllerImpl implements Controller {
    ...
    public String addAnimal(String areaName, String animalType, String animalName, String kind, double price) {
        ...
        boolean animalBelongsToLandArea = areaType.equals("LandArea") && animalType.equals("TerrestrialAnimal");
        boolean animalBelongsToWaterArea = areaType.equals("WaterArea") && animalType.equals("AquaticAnimal");

        if (animalBelongsToLandArea || animalBelongsToWaterArea) {
    ...
    public String calculateKg(String areaName) {
        ...
        double sumKgs = animals.stream().mapToDouble(Animal::getKg).sum();

        return String.format(KILOGRAMS_AREA, areaName, sumKgs);
    }
