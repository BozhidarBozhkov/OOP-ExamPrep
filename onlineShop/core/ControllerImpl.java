...
//
//        Peripheral peripheralId = peripherals.stream().filter(c -> c.getId() == id).findFirst().orElse(null);
...
//        Component componentId = components.stream().filter(c -> c.getId() == id).findFirst().orElse(null);
//        if (componentId != null) {
...
//        }
    ...
    public String BuyBestComputer(double budget) {
        List<Computer> bestComputer = computers.stream().filter(c->c.getPrice() <= budget)
